    ...
    public class UserService
    {
        ...
        public static async Task CountUsers(GraphServiceClient graphClient)
        {
            ...
            try
            {
                // Get all users 
                var users = await graphClient.Users.GetAsync();
               var usersResult = users.Value.Select(e => new { e.DisplayName, e.Id, e.Identities });
        ...
        public static async Task CreateUserWithCustomAttribute(GraphServiceClient graphClient, string b2cExtensionAppClientId, string tenantId)
        {
            ...
            try
            {
                ...
                .PostAsync(new User
                {
                    Id= "460c54c0-0620-45ce-a69a-4ddd89a91ab7",
                    GivenName = "Test",
                    Surname = "B2C",
                    DisplayName = "Test B2C",
                    Identities = new List<ObjectIdentity>
            ...
            {
                //if (ex.ResponseStatusCode == System.Net.HttpStatusCode.BadRequest)
                //{
                    Console.ForegroundColor = ConsoleColor.Red;
